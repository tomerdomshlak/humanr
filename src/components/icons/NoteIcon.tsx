...
function NoteIcon({ fill }: Props) {
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M18.83 5.03a2.83 2.83 0 00-.77-.45c-.29-.11-.58.12-.64.42-.34 1.71-1.85 3-3.67 3h-3.5c-1 0-1.94-.39-2.65-1.1a3.7 3.7 0 01-1.02-1.89c-.06-.3-.36-.54-.65-.42C4.77 5.06 4 6.12 4 8.25V18c0 3 1.79 4 4 4h8c2.21 0 4-1 4-4V8.25c0-1.63-.45-2.63-1.17-3.22zM8 12.25h4c.41 0 .75.34.75.75s-.34.75-.75.75H8c-.41 0-.75-.34-.75-.75s.34-.75.75-.75zm8 5.5H8c-.41 0-.75-.34-.75-.75s.34-.75.75-.75h8c.41 0 .75.34.75.75s-.34.75-.75.75z"
      ></path>
    </svg>
  );
}
